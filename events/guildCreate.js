...
module.exports = async ( guild, member ) => {
    ...
    const channel = member.guild.channel.find(channel => channel.id === "699209481460121670");
    channel.send(WoW)
    client.user.setActivity(`Moderating ${client.guilds.size} servers with ${client.guild.memberCount} members!`);
